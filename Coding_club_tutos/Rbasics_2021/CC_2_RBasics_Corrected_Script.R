...
dev.off() # creates the figure directly into the WD and saves it at the same time 
...
sp_names <- c("sparrow","kingfisher","eagle","hummingbird")

# to plot + save in working directory 
png("barplot2.png", width=950, height=500)
barplot(height = wingspan, names.arg = sp_names, col = "#ddffa2", xlab = "Species", ylab = "Wingspan (cm)")
dev.off()
